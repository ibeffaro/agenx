    ...
    $.fn.appinityTable = function(options) {
            ...
            if((toleransiY == 0 && toleransiX == 0) || rightContainer.find('table').find('tr').length == 0) {
                if(topContainer.find('table').outerWidth() > topContainer.outerWidth()) {
                    topContainer.css({
                        'overflow-y': 'scroll',
                        'overflow-x': 'hidden',
                        'min-height': topContainer.find('table').outerHeight()
                    });
                    setTimeout(function(){
                        topContainer.css({
                            'min-height': topContainer.find('table').outerHeight()
        ...
        function colContextMenu() {
            if(settings.freezeCol) {
                ...
                $.contextMenu({
                    ...
                    items: {
                        freeze      : {
                            name    : lang.freeze_kolom,
                            icon    : 'fa-arrow-to-left'
                        },
                        unfreeze    : {
                            name    : lang.unfreeze_kolom,
                            icon    : 'fa-arrow-to-right',
                        },
                        unfreezeAll : {
                            name    : lang.unfreeze_semua_kolom,
        ...
        function getData() {
            ...
            if(infoSection.length > 0) {
                infoSection.html('<i class="d-inline-block fa-spinner-third fa-spin me-2 text-app"></i>' + lang.mohon_tunggu);
            }
            ...
            var ajaxConfig  = {
                ...
                success : function(r) {
                    ...
                    if(parseInt(r.total_data) == 0) {
                       infoSection.html(lang.tidak_ada_data); 
                    } else {
                        if(totalRecord == 0) {
                            infoSection.html(lang.tidak_ada_data_yang_cocok);
                        } else {
                    ...
                    if(r.status == 'failed') {
                        if(typeof r.message != 'undefined') {
                            ...
                            infoSection.html('<span class="text-danger">' + lang.terjadi_kesalahan + '</span>');
                        }
                    } else {
                                        ...
                                        $(this).find('thead').children().first().children().each(function(){
                                            ...
                                            if(typeof string != 'undefined') {
                                                ...
                                                if(__type == 'date' || __type == 'daterange') {
                                                    ...
                                                    __suffix = "";
                                                    if(string == '0') {
                                                        string  = '<span class="badge badge-icon rounded-pill bg-danger" data-appinity-tooltip="top" aria-label="'+lang.tidak+'"><i class="fa-times"></i></span>';
                                                    } else {
                                                        string  = '<span class="badge badge-icon rounded-pill bg-success" data-appinity-tooltip="top" aria-label="'+lang.ya+'"><i class="fa-check"></i></span>';
                                                    }
                                                } else if(__type == 'image') {
                                                    __prefix = "";
                                                    __suffix = "";
                                                    var imgShow = '';
                                                    if(typeof r.default_image != 'undefined') imgShow = r.default_image;
                                                    ...
                                                    if(__img_popup && string) {
                                                        string = '<a href="'+ imgShow +'" data-lightbox="appinityTable-set"><img src="'+ imgShow +'" class="img-thumbnail" alt="'+string+'"></a>';
                                                    } else {
                                                        string = '<img src="'+ imgShow +'" class="img-thumbnail" alt="'+string+'">';
                                                    }
                                                }  else if(__type == 'image-link') { // penambahan Ibef
                                                    if(__img_popup && string) {
                                                        string = '<a href="'+ string +'" data-lightbox="appinityTable-set"><img src="'+ string +'" class="img-thumbnail" alt="'+string+'"></a>';
                                                    } else {
                                                        string = '<img src="'+ string +'" class="img-thumbnail" alt="'+string+'">';
                                                    } // End
                ...
                complete : function(xhr, stat){
                    if(xhr.responseJSON !== undefined) {
                        ...
                        if(typeof res.__badge === 'object') {
                            $('.sidebar a .badge').each(function(){
                                $(this).remove();
                            });
                            $.each(res.__badge, function(kb, vb){
                                if(parseInt(vb) > 0) {
                                    $('a[href="'+baseURL(kb)+'"]').append('<span class="badge badge-danger">'+vb+'</span>');
                                }
                            });
                        }
                    }
        ...
        this.each(function(){
                        ...
                        if(_col.attr('data-content')) {
                            ...
                            if(typeof _col.attr('data-type') != 'undefined') {
                                ...
                                if(_type == 'date') {
                                    ...
                                    _filter = 'boolean';
                                } else if(_type == 'image' || (_type == 'tags' && typeof _col.attr('data-filter') != 'undefined') ) {
                                    _filter = '';
                                    _sort   = false;
                                }
                            }
                            ...
                            if(inArray(_filter,['text','date','daterange','currency'])) {
                                ...
                                rightThead.children().last().append('<th class="'+_class+'"><input type="text" class="form-control" data-filterType="'+_filter+'"'+_range+' /></th>');
                            } else if(_filter == 'select') {
                                rightThead.children().last().append('<th class="'+_class+'"><select class="form-select" data-filterType="'+_filter+'">'+$('select[data-filter-id="'+attrFilter+'"]').html()+'</select></th>');
                                ...
                                rightThead.children().last().append('<th class="'+_class+'"><select class="form-select" data-filterType="'+_filter+'">'+optList+'</select></th>');
                            } else if(_filter == 'boolean') {
                                rightThead.children().last().append('<th class="'+_class+'"><select class="form-select" data-filterType="'+_filter+'"><option value=""></option><option value="1">'+lang.ya+'</option><option value="0">'+lang.tidak+'</option></select></th>');
                            } else {
                                rightThead.children().last().append('<th class="'+_class+'">&nbsp;</th>');
                            }
            ...
            if(control) {
                ...
                _control.append('<div class="appinityTable-control-left"><span class="appinityTable-label">'+lang.baris_per_halaman+'</span><select class="form-select" data-width="resolve" data-limit></select><div class="appinityTable-info-data">'+lang.tidak_ada_data+'</div></div>');
                ...
                _control.append( 
                    '<div class="appinityTable-control-right">' +
                        '<button class="btn" data-page-button="prev" data-appinity-tooltip="top" aria-label="'+lang.halaman_sebelumnya+'">&lsaquo;</button>' +
                        ...
                        '</div>' +
                        '<button class="btn" data-page-button="next" data-appinity-tooltip="top" aria-label="'+lang.halaman_selanjutnya+'">&rsaquo;</button>' +
                    '</div>'
                );
