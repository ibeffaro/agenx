...
// "colorize" the widget name
    $.widget("flowchart.flowchart", {
        ...
        _getOperatorFullElement: function (operatorData) {
            ...
            var $operator_default = $('<div class="flowchart-operator-default"></div>');

            if (this.options.verticalConnection) {
                $operator_outputs.appendTo($operator);
                $operator_inputs.prependTo($operator);
                $operator_default.appendTo($operator);
            } else {
                ...
                $operator_default.appendTo($operator_inputs_outputs);
            }
            ...
            for (var key_d in infos.default) {
                if (infos.default.hasOwnProperty(key_d)) {
                    addConnector(key_d, infos.default[key_d], $operator_default, 'default');
                }
            }
