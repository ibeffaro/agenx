                            ...
                            success : function(r) {
                                if(typeof r.status != 'undefined' && typeof r.message != 'undefined') {
                                    ...
                                    form.find(':input').each(function(){
                                        ...
                                        if(typeof v != 'undefined') {
                                            if(t.prop('tagName') == 'SELECT') {
                                                ...
                                                if(typeof dataPath != 'undefined' && dataPath != '' && v != '') {
                                    ...
                                    if(
                                        ...
                                        r.created_at != '0000-00-00 00:00:00' &&
                                        r.created_by != ''
                                    ) {
                                        ...
                                        r.updated_at != '0000-00-00 00:00:00' &&
                                        r.updated_by != ''
                                    ) {
...
function printData(html,header) {
    ...
    $('body').append('<div id="temp-print-data">'+html+'</div>');
